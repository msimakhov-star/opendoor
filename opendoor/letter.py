...
# Red only. nhs.uk allows a surgery to ask for documents "for other reasons, like helping to find or transfer your medical
# records", so an amber page (asks, but not as a requirement) does not contradict it and gets no letter.
LETTER_CATEGORIES = ("demands_documents",)


def draft_letter(r: dict) -> str:
    """r is a PracticeResult dict. Returns plain text, or "" when there is nothing to write about (no verified quote, or not red)."""
